...
const Contact = () => {
  return (
    <div className='contact max-w-5xl mx-auto px-6 py-24  flex justify-center items-center bg-red'>
      <div className="bg-gradient-to-br from-primary/20 via-primary/5 to-transparent rounded-[2rem] p-12 md:p-20 border border-primary/20 text-center relative overflow-hidden">
        ...
        <div className="rounded-4xl flex flex-col justify-center items-center gap-6">
            ...
            <a href="https://wa.me/2349044646303?text=Hello%20Isaac%20Luka"><button className='bg-blue hover:bg-blue/90 px-8 py-4 rounded-lg transition-all shadow-xl shadow-primary/30 active:scale-95'>Contact Me</button></a>
        </div>
      </div>
